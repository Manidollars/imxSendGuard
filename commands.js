        ...
        case 1:
          ...
          return new Promise(function (resolve) {
            mailItem.notificationMessages.replaceAsync("ExternalDomainWarning", {
              ...
              message: "Warning: One or more recipients do not belong to :inMailX.onmicrosoft.com."
            }, function () {
              return resolve();
            });
          });
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 2:
          ...
          checkTo = event.changedRecipientFields ? event.changedRecipientFields.to : !!event.to;
          checkCc = event.changedRecipientFields ? event.changedRecipientFields.cc : !!event.cc;
          checkBcc = event.changedRecipientFields ? event.changedRecipientFields.bcc : !!event.bcc; // Execute the shared validation logic
          _context2.n = 3;
